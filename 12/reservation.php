...
{	$k=1;
	...
	$sql="SELECT * FROM $tbl_name WHERE (Ori='$from' or st1='$from' or st2='$from' or st3='$from' or st4='$from' or st5='$from' or st6='$from' or st7='$from' or st8='$from' or st9='$from' or st10='$from' ) and (st1='$to' or st2='$to' or st3='$to' or st4='$to' or st5='$to' or st6='$to' or st7='$to' or st8='$to' or st9='$to' or st10='$to' or Dest='$to') and ($day='Y')";
