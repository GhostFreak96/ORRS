...
mysqli_select_db($conn,"$db_name") or die("cannot select db");
	...
	$tostn=$_GET['tostn'];
	$DOB=$_GET['DOB'];
	$sql="SELECT pnr,Tnumber,doj,Name,Age,Sex,Status,DOB,class FROM $tbl_name WHERE (uname='$name1' and Tnumber='$tno' and doj='$doj' and DOB='$DOB' and fromstn='$fromstn' and tostn='$tostn')";
...
<body>
	...
	<div >
				...
				<table class="table">
				<tr class="text-info">
					<td>Credits Debited in Rs:<?php $tot=($n-1)*$amt;echo $tot;?></td>
				</tr>
				</table>
