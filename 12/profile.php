		...
		<div class="span12 well pass1">
			...
			<tr>
				<td>
					...
					<tr><td>Credits Remaining: </td> <td><h4><font color=brown><?php echo $row['credits']; ?></font></h4></td></tr>
					<tr><td><font color=blue>Note:Please Add 2500 Credits or greater.</font></td></tr>
					<tr><td></td> <td></td></tr>
					</table>
					</div>
				</td>
		...
		<div class="span8 well">
			...
			<tr>
				<td>
					...
					<tr><td>Add credits  </td>  <td><input name="credits1" type="text" value="<?php echo $row['credits'];?>"></td></tr>
