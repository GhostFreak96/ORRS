...
<body>
	...
	<div class="wrap">
		...
		<tr>
			<td style="border-top:0px;"> Enter Credits <font color=red>* </font> </td>
			<td style="border-top:0px;"><input type="text" name="addcredits" class="input-block-level" placeholder="Add atleast 5000 credits" onblur="return showAlert()"><span id="addcredits"></span></td>
		</tr>
