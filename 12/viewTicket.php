...
<body>
	...
	<div class="wrap">
		...
		<div  class=" well login">
			<form class="form-signin " method="post" action="viewTicket2.php">
		<br>
			...
			<tr>
			<td style="border-top:0px;left:15px"><input class="btn btn-info" type="submit" value="View Ticket"><center></td>
			</tr>
